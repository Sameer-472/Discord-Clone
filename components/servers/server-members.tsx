...
export const ServerMember = ({member , server}: ServerMemberProps) =>{
    ...
    return (
        <button className={cn("group px-2 py-2 rounded-md flex items-center hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1" , params?.memeberId === member.id && "bg-zinc-700/20 dark:bg-zinc-700")}>
